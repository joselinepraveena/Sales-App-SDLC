# Pricing & Promotions runbook

## Owners

Domain team `pricing-domain` with platform on-call for cluster and pipeline failures.

## SLIs

Availability of `/api/v1/quotes`, p95 latency, error rate, and queue lag where KEDA is enabled.
