# Sales Analytics runbook

## Owners

Domain team `analytics-domain` with platform on-call for cluster and pipeline failures.

## SLIs

Availability of `/api/v1/kpis`, p95 latency, error rate, and queue lag where KEDA is enabled.
