...
Domain team `payment-domain` with platform on-call for cluster and pipeline failures.

## SLIs

Availability of `/api/v1/payments/authorize`, p95 latency, error rate, and queue lag where KEDA is enabled.
